...
<div class="fre-background" id="background_banner" style="background-image: url('IMG/freelancer-bg.png');">
    <div class="fre-bg-content">
        <div class="container">
            ...
            <a class="fre-btn primary-bg-color" href="projects">Find Projects</a>
            <a class="fre-btn primary-bg-color" href="profile">Update Profile</a>							
        </div>
    </div>
</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="fre-work-block">
					...
					<p id="desc_work_3">Use WorkPlace platform to chat and share files</p>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6">
				<div class="fre-work-block">
...
<div class="fre-service">
    <div class="container">
        <h2 id="title_service">Select the level of service you need for project bidding</h2>
                    ...
                    <div class="row fre-service-package-list">
                        <div class="col-md-4 col-sm-6">
                            <div class="fre-service-pricing">
                                ...
                                <div class="service-info">
                                    <h3>Standards</h3>
                                    <p></p>
                                    <p>You will have 20 bids for project bidding</p>
                                    <p></p>
                                </div>
                                <a class="fre-service-btn primary-color-hover" href="">Purchase</a>
                            </div>				
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="fre-service-pricing">							
                                ...
                                <div class="service-info">
                                    <h3>High</h3>
                                    <p></p><p>You will have 50 bids for project bidding</p>
                                    <p></p>
                                </div>
                                <a class="fre-service-btn primary-color-hover" href="">Purchase</a>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6">			
                            <div class="fre-service-pricing">
                                ...
                                <div class="service-info">
                                    <h3>Premium</h3>
                                    <p></p><p>You will have 100 bids for project bidding</p>
                                    <p></p>
                                </div>
                                <a class="fre-service-btn primary-color-hover" href="">Purchase</a>
                            </div>
...
<div class="fre-get-started">	
	...
	<div class="get-started-content">
            <h2 id="title_start">It's time to start finding freelance jobs online!</h2>
            <a class="fre-btn fre-btn primary-bg-color" href="projects">Find Projects</a>
        </div>
    </div>
</div>